...
import { Player, PlayerOpts, PlayerState } from ".."
import { GameOpts, GameState } from "./game.model"
...
export class Table {
    ...
    public constructor(opts : any) {
        ...
        this.capacity = 2;
        this.players = [];
        this.state =  opts.state || GameState.WAITING;
        this.isFull = false;
        this.turnIndex = 0;
    ...
    public join(playerOpts: PlayerOpts, color : number, contestData:ContestData) : any {
    }
